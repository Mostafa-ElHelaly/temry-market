...
class GetProductDetailsUseCase
    extends UseCase3<List<ProductDetailsModel>, NoParams> {
  final ProductRepository baseRepository;

  GetProductDetailsUseCase({required this.baseRepository});

  @override
  Future<Either<String, List<ProductDetailsModel>>> call(
      NoParams params) async {
    final result = await baseRepository.getdetailsproducts();
